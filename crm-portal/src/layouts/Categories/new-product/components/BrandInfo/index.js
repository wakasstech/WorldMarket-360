...
import BrandImage from "../Media/brandMedia";
...
function BrandInfo({ formData, handleChange,handleImageChange, errors, countryOptions }) {
  ...
  return (
    <ArgonBox>
      <ArgonTypography variant="h5">Brand Information</ArgonTypography>
      <ArgonBox mt={3}>
      ...
      <ArgonBox mt={2}>
        ...
        <BrandImage handleImageChange={handleImageChange}  error={errors.image}/>
      </ArgonBox>
    </ArgonBox>
  );
}
