...
if (myCategoryImage) {
  data.append('category_image', myCategoryImage?.originFileObj)
} else {
...
setLoading(true); // Set loading state to true
    ...
    try {
      const action = await dispatch(createCategory(data));
      ...
      setAlert({ open: true, message: "Failed to create caetgory. Please try again.", severity: "error" });
    }   finally {
