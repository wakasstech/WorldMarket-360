...
function CategoryInfo({ formData, handleChange, handleImageChange, errors }) {
  return (
    <ArgonBox>
      <ArgonTypography variant="h5">Ad Information</ArgonTypography>
      <ArgonBox mt={3}>
...
{/* <ArgonBox mb={1} ml={0.5} lineHeight={0} display="inline-block">
              ...
              <ArgonSelect
                name="ad_name"
                value={{ value: formData.ad_name, label: formData.ad_name }}
                onChange={(selected) => handleChange({ target: { name: "ad_name", value: selected.value } })}
                options={[
              ...
              type="text"
              label="title"
              placeholder="Enter a title of the ad"
              name="ad_name"
              value={formData.ad_name}
              onChange={handleChange}
              // error={errors.ad_name}
